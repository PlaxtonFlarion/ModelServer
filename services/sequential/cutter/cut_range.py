...
from services.sequential import (
    const, toolbox
)
from services.sequential.hook import BaseHook
...
class VideoCutRange(object):
    ...
    def contain_image(
        ...
        return frame.contain_image(
            image_path=image_path, image_data=image_data, **kwargs
        )
    ...
    def is_stable(
        ...
        if res and psnr_threshold:
            res = numpy.mean(self.psnr) > psnr_threshold
